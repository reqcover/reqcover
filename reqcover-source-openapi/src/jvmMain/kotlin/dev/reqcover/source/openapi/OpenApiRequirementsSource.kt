...
class OpenApiRequirementsSource : JvmRequirementsSource {
    override fun load(inputStream: InputStream): Set<String> =
        loadOpenApiRequirements(YAMLMapper().readTree(inputStream))
}
